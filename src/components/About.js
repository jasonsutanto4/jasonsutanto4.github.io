        ...
        <Container fluid style={{height: "75vh"}} id="about">
            ...
            <Row style={{justifyContent: "center", alignItems: "center", height: "80%"}}>
                ...
                <Col sm={9} md={10} lg={{ span: 5, offset: 1}}>
                    <h1>Hi! I am Jason sutanto</h1>
                    <h4 style={{fontWeight: "300"}}>
                        I am a student at The Hong Kong Polytechnic University, studying Industrial Engineering.
                        I love to learn new skills in my spare time. When I am not doing either of it,
                        I'll probably play games or exercise.
                    </h4>
                </Col>
            </Row>
        </Container>
